 ...
 */
package org.esempio.core.constants;

/**
 * Global class for all EsempioCore constants. You can add global constants for your extension into this class.
 */
public final class EsempioCoreConstants extends GeneratedEsempioCoreConstants
{
	public static final String EXTENSIONNAME = "esempiocore";


	private EsempioCoreConstants()
	{
		//empty
	}
