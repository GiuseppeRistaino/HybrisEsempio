 ...
 */
package org.esempio.core.suggestion;
...
import org.esempio.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/esempiocore/test/testSimpleSuggestionService.csv", "utf-8");
	}
