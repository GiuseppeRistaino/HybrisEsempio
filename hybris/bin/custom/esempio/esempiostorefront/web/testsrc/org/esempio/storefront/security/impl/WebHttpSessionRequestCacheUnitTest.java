...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/esempiostorefront/electronics/en",
						"https://electronics.local:9002/esempiostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/esempiostorefront/electronics/en",
						"https://electronics.local:9002/esempiostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/esempiostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/esempiostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/esempiostorefront/electronics/en",
						"https://electronics.local:9002/esempiostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/esempiostorefront",
						"https://electronics.local:9002/esempiostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/esempiostorefront",
						"https://electronics.local:9002/esempiostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/esempiostorefront/electronics/en",
						"https://electronics.local:9002/esempiostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
