 ...
 */
package org.esempio.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(EsempioFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EsempioFulfilmentProcessConstants.PARENT_PROCESS);
