 ...
 */
package org.esempio.test.setup;
...
import org.esempio.test.constants.EsempioTestConstants;
import org.esempio.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EsempioTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/esempiotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/esempiotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/esempiotest/import/cstickets.impex");
			...
			importImpexFile(context, "/esempiotest/import/csquotes.impex");
		}
	}
}
